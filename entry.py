...
def set_seed(seed: int = 42, seed_data: int = 42):
    # Python built-in
    random.seed(seed)
    ...
    # Force hash seed (affects some Python hash operations)
...
if __name__ == '__main__':
    ...
    #set_seed(config['model']['random_seed'], config['dataloader']['random_seed']) # shereen modification
